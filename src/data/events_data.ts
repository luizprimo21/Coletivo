...
export const EVENTS: EventItem[] = [
  {
    id: 'top-1',
    title: 'Conjuntura política atual e os impactos na educação',
    date: '24 ABR 2026',
    link: 'https://www.youtube.com/watch?v=5mJaGPlNba0',
    thumbnail: 'https://img.youtube.com/vi/5mJaGPlNba0/hqdefault.jpg',
    description: 'Daniel Cara e Luiz Nassif debatem os rumos da política e da educação no Brasil.',
  },
  {
    id: '0',
    title: 'Lançamento: Cadernos de Educação nº01',
    date: '15 MAR 2025',
    ...
    description: 'Apresentação do primeiro volume dos Cadernos de Educação do Coletivo Paulo Freire.',
  },
  {
    id: 'extra-1',
